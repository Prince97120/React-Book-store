                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-400 mb-4 max-w-md">
                            Your one-stop destination for discovering, buying, and enjoying books. 
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/books" className="text-gray-400 hover:text-amber-600 transition-colors">
                                    All Books
                                </Link>
                            </li>
                            <li>
                                <Link to="/cart" className="text-gray-400 hover:text-amber-600 transition-colors">
                                    Shopping Cart
                                </Link>
                            </li>
                            <li>
                                <Link to="/orders" className="text-gray-400 hover:text-amber-600 transition-colors">
                                    My Orders
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center space-x-3">
                                ...
                                <span className="text-gray-400">123 Book Street, Library City, LC 12345</span>
                            </div>
                            <div className="flex items-center space-x-3">
